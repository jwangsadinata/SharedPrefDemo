package hu.ait.android.sharedprefdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivity.this, startTime, Toast.LENGTH_SHORT).show();
    ...
    private String getLastStartTime() {
        ...
        return (startTime != -1) ? new Date(startTime).toString() : "This is my first launch!!";
    }
}
